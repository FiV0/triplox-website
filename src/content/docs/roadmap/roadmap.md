...
for future updates and in the standard query case this bookkeeping is pointless and hence an engine optimized for one-off queries should most of time be faster as this overhead is not done.
